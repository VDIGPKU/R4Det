...
class LiDARInstance3DBoxes2(BaseInstance3DBoxes):
    ...
    def convert_to(self, dst, rt_mat=None):
        ...
        """
        from .box_3d_mode2 import Box3DMode2
        return Box3DMode2.convert(
            box=self, src=Box3DMode2.LIDAR, dst=dst, rt_mat=rt_mat)
