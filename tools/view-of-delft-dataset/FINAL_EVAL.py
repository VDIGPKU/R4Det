...
def parse_args():
    ...
    parser.add_argument('--pred_results', default='./tools/view-of-delft-dataset/pred_results/vod-RadarPillarNet')
...
if __name__ == '__main__':
    ...
    #eval_results(test_root='/data/tangyousen/view-of-delft_PUBLIC/view_of_delft_PUBLIC/lidar/training',pred_results=args.pred_results)
